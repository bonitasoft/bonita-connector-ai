 ...
 *
 * <p>Automatically builds a BAR with the Gemini connector, deploys it to the Studio,
 ...
 * }</pre>
 *
 * <p>Requires: Bonita Studio running at localhost:8080, GEMINI_API_KEY env var set
 */
@Slf4j
@Tag("btt")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class GeminiConnectorStudioIT {
    ...
    static void setUp() throws Exception {
        Assumptions.assumeTrue(System.getenv("GEMINI_API_KEY") != null, "GEMINI_API_KEY env var required");
        ...
        toolkit = BonitaTestToolkitFactory.INSTANCE.get(GeminiConnectorStudioIT.class);
    }
    ...
    private static void deployConnectorProcess(BonitaClient client) throws Exception {
        ...
        File barFile = null;
        try {
            barFile = Files.createTempFile("gemini-studio-test", ".bar").toFile();
            barFile.delete();
