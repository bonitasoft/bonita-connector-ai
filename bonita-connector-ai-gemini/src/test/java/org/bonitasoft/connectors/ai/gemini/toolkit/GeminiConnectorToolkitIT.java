...
import org.bonitasoft.connectors.ai.toolkit.AiConnectorTestToolkit.Output;
...
/**
 * Integration tests that deploy Gemini AI connectors into a real Bonita runtime
...
class GeminiConnectorToolkitIT {

    private static final String GEMINI_ASK_DEF_ID = "gemini-ask";
    private static final String GEMINI_ASK_DEF_VERSION = "1.0.0";

    private static final String ARTIFACT_ID = "bonita-connector-ai-gemini";

    private static final Logger LOGGER = LoggerFactory.getLogger(GeminiConnectorToolkitIT.class);
    ...
    static void installOrganization() {
        ...
        var orgFile = GeminiConnectorToolkitIT.class.getResource("/ACME.xml");
        if (orgFile != null) {
    ...
    void should_execute_ask_connector_in_bonita_process() throws Exception {
        ...
        var barFile = AiConnectorTestToolkit.buildConnectorToTest(
                GEMINI_ASK_DEF_ID, GEMINI_ASK_DEF_VERSION, inputs, outputs, ARTIFACT_ID);
