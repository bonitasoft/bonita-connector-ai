...
@Slf4j
@Tag("provider-api")
class GeminiExtractChatIT extends ExtractChatIT {
    ...
    protected ExtractChat getChat(AiConfiguration configuration) {
        return new GeminiExtractChat(configuration);
    }
    ...
    void should_extract_data_from_png_with_vision() throws Exception {
        // Given - Gemini supports native vision for images
