...
/**
 * Property-based tests specific to the Classify operation of the Cohere connector.
 * Validates that CohereClassifyChat handles random valid inputs correctly.
 */
class CohereClassifyConnectorPropertyTest {
    ...
    void modelNameOptional(@ForAll @AlphaChars @StringLength(min = 1, max = 100) String modelName) {
        ...
        assertThat(new CohereClassifyChat(configWith).getChatModel()).isNotNull();
        assertThat(new CohereClassifyChat(configWithout).getChatModel()).isNotNull();
