...
/**
 * Property-based tests specific to the Ask operation of the Cohere connector.
 * Validates that CohereAskAiChat handles random valid inputs correctly.
 */
class CohereAskConnectorPropertyTest {
    ...
    void baseUrlOptional(@ForAll @AlphaChars @StringLength(min = 1, max = 50) String apiKey) {
        ...
        assertThat(new CohereAskAiChat(configWithout).getChatModel()).isNotNull();
        assertThat(new CohereAskAiChat(configWith).getChatModel()).isNotNull();
