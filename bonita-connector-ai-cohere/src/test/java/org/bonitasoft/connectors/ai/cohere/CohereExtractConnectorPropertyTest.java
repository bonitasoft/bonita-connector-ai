...
/**
 * Property-based tests specific to the Extract operation of the Cohere connector.
 * Validates that CohereExtractChat handles random valid inputs correctly.
 */
class CohereExtractConnectorPropertyTest {
    ...
    void modelNameOptional(@ForAll @AlphaChars @StringLength(min = 1, max = 100) String modelName) {
        ...
        assertThat(new CohereExtractChat(configWith).getChatModel()).isNotNull();
        assertThat(new CohereExtractChat(configWithout).getChatModel()).isNotNull();
