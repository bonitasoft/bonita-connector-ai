...
class ExtractConfigurationTest {

    @Test
    void should_return_empty_list_when_no_document_refs() {
        var config = ExtractConfiguration.builder().build();
    ...
    void should_return_single_ref_when_only_sourceDocumentRef_set() {
        var config = ExtractConfiguration.builder().sourceDocumentRef("doc1").build();
    ...
    void should_return_list_when_only_sourceDocumentRefs_set() {
        var config = ExtractConfiguration.builder()
